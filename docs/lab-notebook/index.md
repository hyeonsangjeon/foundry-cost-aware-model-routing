...
- **[실험 07 · 라우팅 레이어](07-model-router.md)** ⭐ *센터피스* — Azure AI Foundry Model Router처럼 **한 번 고르면**? 커버리지 52% (관찰-후-에스컬레이션 mix는 비슷한 비용에 100%, 이득 +48%p) · *선택은 내장 라우터가, 검증·거버넌스는 이 저장소가*
